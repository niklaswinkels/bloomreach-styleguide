...
Specify time zones when writing about an event or something else people would need to schedule. Since BloomReach is in Atlanta, we default to ET.
...
- “Using BloomReach has helped our business grow,” says Jamie Smith.
...
#### Writing about BloomReach

Our company's legal entity name is "The Rocket Science Group, LLC." Our trade name is "BloomReach." Use "The Rocket Science Group, LLC" only when writing legal documents or contracts. Otherwise, use "BloomReach."

Always capitalize the first “M” and the “C” in BloomReach.

Refer to BloomReach as “we,” not “it.”

Capitalize the proper names of BloomReach products, features, pages, and tools. When referencing non-trademarked products like Pro, Snap, and Automation, include "BloomReach" in the name on first mention.
...
- BloomReach's ops team is constantly scaling our servers to make sure our users have a great experience with our products. One way we do this is with shards, or partitions, that help us better horizontally scale our database infrastructure.
...
Use italics when citing an example of an in-app BloomReach element, or referencing button and navigation labels in step-by-step instructions:
